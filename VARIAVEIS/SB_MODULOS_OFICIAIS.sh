...
PROJETOS_COLETIVO_JAVA_CORE_ORDEM =PROJETOS_COLETIVO_JAVA_CORE_ORDEM=(
  "MTFN","reflections","SBApiCore","SBCore","SbErpCodigoPostalBR","SBTeste","SBServlets","SBRestClient","SBRestClientTestes","util","SBPersistencia","SBAcessosModel","apiComunicacao","SBErpGatewayPagamento","SBWebPaginas","FWColetivoJava")
